...
class Property(models.Model):
    ...
    listing_price = models.DecimalField(decimal_places=2, max_digits=12, blank=False)
    current_price = models.DecimalField(decimal_places=2, max_digits=12, blank=False)
    market_price = models.DecimalField(decimal_places=2, max_digits=12, blank=False)
    ...
    lock_in_period = models.DecimalField(decimal_places=2, max_digits=5, blank=False)
    lease_period = models.DecimalField(decimal_places=2, max_digits=5, blank=False)
    dilution = models.DecimalField(decimal_places=2, max_digits=4, blank=False)
    approval_status = models.IntegerField(default=0) #0 for not approved, 1 for approved
